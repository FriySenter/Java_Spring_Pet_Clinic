...
class PetControllerTest {
    ...
    void initCreationForm() throws Exception {
        ...
        when(os.findById(anyLong())).thenReturn(owner);
        when(pts.findAll()).thenReturn(petTypes);
    ...
    void initUpdateForm() throws Exception {
        ...
        when(os.findById(anyLong())).thenReturn(owner);
        when(pts.findAll()).thenReturn(petTypes);
        when(ps.findById(anyLong())).thenReturn(Pet.builder().id(2L).build());
    ...
    @Test
    void processUpdatedForm() throws Exception {
